% exampleShow_user - stimulus generation function of experiment 'example' -
%
% This function is called by afc_main when starting
% the experiment 'exampleShow'. It generates the stimuli which
...
%
% See also help exampleShow_cfg, exampleShow_set, afc_main

function exampleShow_user
