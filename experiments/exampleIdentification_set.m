% exampleIdentification_set - setup function of experiment 'exampleConstantStimuli' -
%
% This function is called by afc_main when starting
% the experiment 'exampleConstantStimuli'. It defines elements
% of the structure 'setup'. The elements of 'setup' might be used 
...
% is done here.
%
% See also help exampleIdentification_cfg, exampleIdentification_user, afc_main

function exampleIdentification_set
...
hannlen = round(0.05*def.samplerate);
setup.window = hannfl(def.intervallen,hannlen,hannlen);
