% exampleConstantStimuli_cfg - example measurement configuration file -
%
...
%
% See also help exampleConstantStimuli_set, exampleConstantStimuli_user, afc_main
%
...
def.expvar = [-24 -20 -16 -12 -8];		% fixed values of the variable
...
def.expvarnum = [9 9 9 9 9];  		% number of presentations of variable, same index as in expvar 
def.practice = 1;             		% enables practice presentations
def.practicenum = [0 0 0 4 4];		% number of practice presentations of variable, same index as in expvar
...
def.afcwin = 'afc_2buttonwin';		% response window 'afc_win' = default
def.windetail = 1;
