% exampleShow_set - setup function of experiment 'example' -
%
% This function is called by afc_main when starting
% the experiment 'exampleShow'. It defines elements
% of the structure 'setup'. The elements of 'setup' are used 
% by the function 'exampleShow_user.m'.
% 
...
% is done here.
%
% See also help exampleShow_cfg, exampleShow_user, afc_main

function exampleShow_set
